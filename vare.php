...
class vare
{
 	...
 	public function delt_db()
    {
        ...
        $sql = "Insert into vare (varenavn,varenr,pris,antall,kategorinr,hyllenr,betegnelse,bildeadresse)";
        $sql.= "Values ('$varenavn','$varenr','$pris','$antall','$kategorinr','$hyllenr','$betegnelse','$bildeadresse')";
